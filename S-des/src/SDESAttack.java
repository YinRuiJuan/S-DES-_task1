public class SDESAttack {
    ...
    public static void main(String[] args) {
        ...
        String[] ciphertext={"10010001","00111011","10100010","10111011","11110100","10011110","00100011","01100100","11101011","00110101","01001100","00100001","01101110","00001101","01000001","01100010","11111101","01101101","00000100"};
        SDESAttack sdesAttack=new SDESAttack(plaintext, ciphertext);
        System.out.println(sdesAttack.attack());
        
        /*
        //真实密钥为1010101010
        String[] plainText={"00000001","00000010","00000011","00000100","00000101","00000110"};
        String[] cipherText={"10110101","01001011","01010110","10011111","11010000","11001110"};
        SDESAttack sdesAttack2=new SDESAttack(plainText, cipherText);
        System.out.println(sdesAttack2.attack());
        */
    }   
}